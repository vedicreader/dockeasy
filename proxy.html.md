...
<a
href="https://github.com/Karthik777/dockeasy/blob/main/dockeasy/proxy.py#L15"
...
<a
href="https://github.com/Karthik777/dockeasy/blob/main/dockeasy/proxy.py#L110"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/dockeasy/blob/main/dockeasy/proxy.py#L88"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/dockeasy/blob/main/dockeasy/proxy.py#L134"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def caddy_svc(
    ...
    cloudflared:bool=False, conf:str='Caddyfile', **kw
):
```
...
<a
href="https://github.com/Karthik777/dockeasy/blob/main/dockeasy/proxy.py#L154"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def cloudflared_svc(
    token_env:str='${CF_TUNNEL_TOKEN}', url:NoneType=None, **kw
):
```
...
<a
href="https://github.com/Karthik777/dockeasy/blob/main/dockeasy/proxy.py#L161"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def crowdsec(
    collections:NoneType=None, bouncer_key_env:str='CROWDSEC_BOUNCER_KEY', **kw
):
```
